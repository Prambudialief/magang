...
$result = mysqli_query($conn, "SELECT * FROM materi WHERE id='$id' AND mentor_id='$mentor_id'");
    ...
    <form action="materi.php" enctype="multipart/form-data" method="post">
        ...
        <div class="mb-3">
            ...
            <?php if ($row['file_materi']):?> 
                <a href="../uploads/materi/<?=$row['file_materi'];?>"target="_blank">Lihat File Lama</a><br>
            <?php endif; ?>
